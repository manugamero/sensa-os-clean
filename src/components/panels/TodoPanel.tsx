    ...
    <div className="h-full flex flex-col relative">
      ...
      <div className={`h-full flex flex-col transition-all duration-300 origin-top ${selectedNote ? 'scale-[0.98] opacity-30 pointer-events-none' : 'scale-100 opacity-100'}`}>
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Create Form */}
          {showCreateForm && (
            <div className="mb-4 p-4 border border-gray-200 dark:border-white/[0.08] rounded-lg bg-white dark:bg-black">
              <form onSubmit={createTodo} className="space-y-3">
                <div className="flex items-center gap-2 p-2 border border-gray-200 dark:border-white/[0.08] rounded-md bg-white dark:bg-black">
                  <button
                    type="button"
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-gray-200 dark:border-white/[0.08] rounded-md focus:ring-0 resize-none bg-white dark:bg-black text-gray-900 dark:text-white"
            ...
            <div className="space-y-3">
              {todos.filter(todo => showDone ? todo.isDone : !todo.isDone).map((todoItem) => (
                <div 
                  ...
                  className={`card-hover border border-gray-200 dark:border-white/[0.08] rounded-lg p-3 bg-white dark:bg-black cursor-pointer relative ${todoItem.completed ? 'opacity-50' : ''}`}
                >
